...
#define APP_DEVICE_NAME                 "Geocache"                        //!< Advertised device name in the scan response when in connectable mode.
...
#define BLE_TX_POWER                    4                                 /** Adjust sending power in dBm to meet your geocaching needs **/
