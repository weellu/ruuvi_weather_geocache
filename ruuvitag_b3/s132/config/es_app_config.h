...
#define APP_CONFIG_LOCK_CODE {0x00, 0x11, 0x22, 0x33, \
                              0x44, 0x55, 0x66, 0x77, \
                              0x88, 0x99, 0xAA, 0xBB, \
                              0xCC, 0xDD, 0xEE, 0xFF} //!< Beacon lock code. @warning This lock code must be changed before hiding the geocache!.
...
#define APP_ES_URL_URL           'g', 'o', 'o', '.', 'g', 'l', \
                                 '/', 'a', 'b', 'c', 'd', 'e', 'f'      //!< "Could be left to ruu.vi/setup if wanted or just put the bad weather URL here.""
...
#define DEFAULT_FRAME_LENGTH            13                                //!< 1 - Frame Type, 1 - TX - power 1 - URL Scheme, URL - 12 = 15
